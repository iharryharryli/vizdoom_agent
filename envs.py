...
def make_env_ViZDoom(seed, rank, **kwargs):
    def _thunk():
        
        env = ViZDoomENV(seed + rank, **kwargs)
...
def make_vec_envs_ViZDoom(seed, num_processes, device, **kwargs):
    envs = [make_env_ViZDoom(seed, i, **kwargs)
