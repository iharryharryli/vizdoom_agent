...
class RolloutStorage(object):
    def __init__(self, num_steps, num_processes, obs_shape, action_space, recurrent_hidden_state_size):
        ...
        self.p_hidden_states = torch.zeros(num_steps + 1, num_processes, recurrent_hidden_state_size)
    ...
    def to(self, device):
        ...
        self.p_hidden_states = self.p_hidden_states.to(device)
    ...
    def insert(self, obs, recurrent_hidden_states, p_hidden_states, actions, action_log_probs, value_preds, rewards, masks):
        self.obs[self.step + 1].copy_(obs)
        self.recurrent_hidden_states[self.step + 1].copy_(recurrent_hidden_states)
        self.p_hidden_states[self.step + 1].copy_(p_hidden_states)
    ...
    def after_update(self):
        ...
        self.p_hidden_states[0].copy_(self.p_hidden_states[-1])
