...
class A2C_ACKTR():
    ...
    def update(self, rollouts):
        ...
        values, action_log_probs, dist_entropy, _, _, ob_original, ob_reconstructed, mu, logvar, p_mu, p_logvar =\
         self.actor_critic.evaluate_actions(
                rollouts.obs[:-1].view(-1, *obs_shape),
                rollouts.recurrent_hidden_states[0].view(-1, self.actor_critic.recurrent_hidden_state_size),
                rollouts.p_hidden_states[0].view(-1, self.actor_critic.recurrent_hidden_state_size),
